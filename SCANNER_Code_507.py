...
def show_sample_predictions(generator, num_images=3):
    generator.reset()
    ...
    # Add a main title 
    plt.suptitle("AI Skin Lesion Diagnosis - Clinical Analysis", fontsize=10, fontweight='bold', y=0.98)
...
try:
    test_gen.reset()
    show_sample_predictions(test_gen, num_images=3)
except Exception as e:
